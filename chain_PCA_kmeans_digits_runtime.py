...
run_time = np.zeros(len(dimensions))
...
for dim in dimensions:
    ...
    run_time[dim-2] = time() - t0

print(run_time)

# fig, ax = plt.subplots()
# ax.scatter(dimensions, run_time, c='g')
plt.plot(dimensions, run_time, marker='o', linestyle='--', color='r')
plt.ylabel('Run_time(sec)')
plt.xlabel('Dimensions After PCA reduction')
plt.title("Running time of PCA chained by kmeans")
plt.show()
